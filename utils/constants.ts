...
const GEAR_MUSTACHE_TOKEN_MINT = new PublicKey(
  process.env.NEXT_PUBLIC_GEAR_MUSTACHE_MINT_ADDRESS ?? ""
);
const GEAR_UNICORN_MOUNT_TOKEN_MINT = new PublicKey(
  process.env.NEXT_PUBLIC_GEAR_UNICORN_MOUNT_MINT_ADDRESS ?? ""
);
export const GEAR_TOKEN_MINTS = [
  GEAR_HAT_TOKEN_MINT,
  GEAR_HEADPHONES_TOKEN_MINT,
  GEAR_MUSTACHE_TOKEN_MINT,
  GEAR_UNICORN_MOUNT_TOKEN_MINT,
];
